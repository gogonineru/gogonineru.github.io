...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Gogonineru")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Gogonineru %c 你正在访问Gogonineruの小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Gogonineru") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Gogonineru的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
    ...
    // 网站诞生时间
    var grt = new Date("06/20/2024 13:06:35");
...
function startFPSCounter() {
    ...
    fpsLoop = function () {
        ...
        if (now > 1000 + lastTime) {
            ...
            var kd;
            if (fps <= 5) { kd="`<span" style="color:#bd0000">卡成ppt🤢`;
            } else if (fps <= 15) { kd="`<span" style="color:red">电竞级帧率😖`;
            } else if (fps <= 25) { kd="`<span" style="color:orange">有点难受😨`;
            } else if (fps < 35) {
                kd = `<span style="color:#9338e6">不太流畅🙄</span>`;
            } else if (fps <= 45) { kd="`<span" style="color:#08b7e4">还不错哦😁`;
            } else {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
  <div class="content">
 <div class="bgbox">
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/wallhaven-l8pqwp.jpg
)" class="imgbox" onclick="changeBg('url(https://gogonineru.asia//img/wallhaven-l8pqwp.jpg
)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/wallhaven-85w2go.jpg)" class="imgbox" onclick="changeBg('url(https://gogonineru.asia//img/wallhaven-85w2go.jpg)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/wallhaven-zyqx1v.png)" class="imgbox" onclick="changeBg('url(https://gogonineru.asia//img/wallhaven-zyqx1v.png)')"></a>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class="content">
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Gogonineru/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Gogonineru/img/fj1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class="content">
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Gogonineru/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Gogonineru/img/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class="content">
              <div class="bgbox">
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/77803754_p0_master1200.jpg)" class="pimgbox" onclick="changeBg('url(https://gogonineru.asia//img/77803754_p0_master1200.jpg)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/77032574_p0_master1200.jpg)" class="pimgbox" onclick="changeBg('url(https://gogonineru.asia//img/77032574_p0_master1200.jpg)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/76172945_p0_master1200.jpg)" class="pimgbox" onclick="changeBg('url(https://gogonineru.asia//img/76172945_p0_master1200.jpg)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/74442933_p0_master1200.jpg)" class="pimgbox" onclick="changeBg('url(https://gogonineru.asia//img/74442933_p0_master1200.jpg)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/74279771_p0_master1200.jpg)" class="pimgbox" onclick="changeBg('url(https://gogonineru.asia//img/74279771_p0_master1200.jpg)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/70575047_p0_master1200.jpg)" class="pimgbox" onclick="changeBg('url(https://gogonineru.asia//img/70575047_p0_master1200.jpg)')"></a>
  <a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gogonineru.asia//img/wallhaven-1prokg.jpg)" class="pimgbox" onclick="changeBg('url(https://gogonineru.asia//img/wallhaven-1prokg.jpg)')"></a>
</div>
